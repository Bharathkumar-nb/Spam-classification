...
input_file = os.path.join(os.getcwd(),'Results', 'features', 'filtered_all_features_nonspam.out')
...
json.dump(dic, open(os.path.join(os.getcwd(),'Results', 'features', 'graph_input_filtered_non_spam.json'),'w'))